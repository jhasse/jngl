...
//			jngl::Scale(40, 40);
			...
			jngl::Print("C", 210, 390);
			jngl::Print("D", 310, 390);
			jngl::Print("A", 410, 490);
			jngl::Print("B", 510, 490);
			jngl::Print("C", 610, 390);
			jngl::Print("D", 710, 490);
			jngl::Print("D", 810, 490);
			jngl::Print("D", 910, 590);
			DrawMouse();
			jngl::EndDraw();
		}
	}
